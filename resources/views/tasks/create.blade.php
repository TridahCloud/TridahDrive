                ...
                <form action="{{ route('drives.projects.projects.tasks.store', [$drive, $project]) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select" id="status_id" name="status_id" required>
                                @foreach($statuses as $status)
                                    <option value="{{ $status->id }}" {{ old('status_id', $statuses->first()?->id) == $status->id ? 'selected' : '' }}>
                                        {{ $status->name }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control" id="estimated_hours" name="estimated_hours" min="0" step="0.5" value="{{ old('estimated_hours') }}">
                        </div>
                        <div class="col-md-6 mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="label_ids" name="label_ids[]" multiple>
                            @foreach($labels as $label)
                                <option value="{{ $label->id }}" {{ in_array($label->id, old('label_ids', [])) ? 'selected' : '' }}>
                                    {{ $label->name }}
                                </option>
                            @endforeach
                        </select>
