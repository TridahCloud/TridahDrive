...
@section('title', 'Create Schedule - ' . $drive->name)
...
<div class="container-fluid">
        ...
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <h1 class="display-6 mb-0 brand-teal">Create Schedule</h1>
                </div>
    ...
    <form action="{{ route('drives.people-manager.schedules.store', $drive) }}" method="POST">
        @csrf
