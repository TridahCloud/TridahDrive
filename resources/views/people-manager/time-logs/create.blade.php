    ...
    <form action="{{ route('drives.people-manager.time-logs.store', $drive) }}" method="POST">
        ...
        <div class="dashboard-card mb-4">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="work_description" name="work_description" rows="4" placeholder="Describe the work performed during this time period...">{{ old('work_description') }}</textarea>
