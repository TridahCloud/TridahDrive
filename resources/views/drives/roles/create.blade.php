...
@section('title', 'Create Role - ' . $drive->name)
...
<div class="container-fluid">
    ...
    <form action="{{ route('drives.roles.store', $drive) }}" method="POST" id="roleForm">
        @csrf
                    ...
                    @if($drive->parentDrive && $parentRoles->count() > 0)
                        ...
                        <div class="mb-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="is_inherited" name="is_inherited" value="1" {{ old('is_inherited') ? 'checked' : '' }}>
                        ...
                        <div class="mb-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="override_permissions" name="override_permissions" value="1" {{ old('override_permissions') ? 'checked' : '' }}>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-check mb-2">
                                <input class="form-check-input permission-checkbox" type="checkbox" 
                                       ...
                                       value="1" 
                                       {{ old('permissions.bookkeeper.view') ? 'checked' : '' }}>
                            ...
                            <div class="form-check mb-2">
                                <input class="form-check-input permission-checkbox" type="checkbox" 
                                       ...
                                       value="1" 
                                       {{ old('permissions.invoicer.view') ? 'checked' : '' }}>
                            ...
                            <div class="form-check mb-2">
                                <input class="form-check-input permission-checkbox" type="checkbox" 
                                       ...
                                       value="1" 
                                       {{ old('permissions.people_manager.view') ? 'checked' : '' }}>
                            ...
                            <div class="form-check mb-2">
                                <input class="form-check-input permission-checkbox" type="checkbox" 
                                       ...
                                       value="1" 
                                       {{ old('permissions.mytime.view') ? 'checked' : '' }}>
                            ...
                            <div class="form-check mb-2">
                                <input class="form-check-input permission-checkbox" type="checkbox" 
                                       ...
                                       value="1" 
                                       {{ old('permissions.project_board.view') ? 'checked' : '' }}>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-check mb-2">
                                <input class="form-check-input permission-checkbox" type="checkbox" 
                                       ...
                                       value="1" 
                                       {{ old('permissions.mytime.view_own_schedules') ? 'checked' : '' }}>
                            ...
                            <div class="form-check mb-2">
                                <input class="form-check-input permission-checkbox" type="checkbox" 
                                       ...
                                       value="1" 
                                       {{ old('permissions.mytime.view_own_time_logs') ? 'checked' : '' }}>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-check mb-2">
                                <input class="form-check-input permission-checkbox" type="checkbox" 
                                       ...
                                       value="1" 
                                       {{ old('permissions.project.view_all') ? 'checked' : '' }}>
                            ...
                            <div class="form-check mb-2">
                                <input class="form-check-input permission-checkbox" type="checkbox" 
                                       ...
                                       value="1" 
                                       {{ old('permissions.project.view_assigned') ? 'checked' : '' }}>
                            ...
                            <div class="form-check mb-2">
                                <input class="form-check-input permission-checkbox" type="checkbox" 
                                       ...
                                       {{ old('permissions.project.view_specific') ? 'checked' : '' }}>
                            ...
                            <div id="projectSpecificIds" class="collapse {{ old('permissions.project.view_specific') ? 'show' : '' }} mt-2">
                                ...
                                <select class="form-select" id="project_ids" name="permissions[project.view_specific_ids][]" multiple>
                                    @foreach($projects as $project)
                                        <option value="{{ $project->id }}" {{ in_array($project->id, old('permissions.project.view_specific_ids', [])) ? 'selected' : '' }}>
                                            {{ $project->name }}
                                        </option>
                                    @endforeach
                                </select>
