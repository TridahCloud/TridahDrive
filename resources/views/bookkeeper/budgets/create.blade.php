...
@section('title', 'Create Budget - ' . $drive->name)
        ...
        <div class="col-md-8 offset-md-2">
            <div class="dashboard-card">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h4 class="mb-0"><i class="fas fa-plus me-2"></i>Create New Budget</h4>
                    <a href="{{ route('drives.bookkeeper.budgets.index', $drive) }}" class="btn btn-outline-secondary">
                        <i class="fas fa-arrow-left me-2"></i>Back
                    </a>
                </div>

                <form action="{{ route('drives.bookkeeper.budgets.store', $drive) }}" method="POST">
                    @csrf
