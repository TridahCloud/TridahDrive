...
@section('title', 'Edit Category - ' . $drive->name)
    ...
    <div class="row">
        <div class="col-md-8 offset-md-2">
            <div class="dashboard-card">
                ...
                <form action="{{ route('drives.bookkeeper.categories.update', [$drive, $category]) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="color" name="color" id="color" class="form-control form-control-color" value="{{ old('color', $category->color) }}">
                        @error('color')
                            <div class="text-danger small">{{ $message }}</div>
                        @enderror
                    </div>
